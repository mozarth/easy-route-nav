  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      setStats({
        ...
        mobileAccesses: logs.filter((l: AccessLog) => l.deviceType === 'mobile').length,
        tabletAccesses: logs.filter((l: AccessLog) => l.deviceType === 'tablet').length,
        desktopAccesses: logs.filter((l: AccessLog) => l.deviceType === 'desktop').length,
      });
      setLoading(false);
    };
    loadData();
